...
public class XmlToCsvConverter : IConverter<XmlData, string>
{
    ...
    private static XmlDataFormat DetermineDataFormat(XmlData input)
    {
    ...
    private static string ConvertFromDocument(XmlData input, object? options)
    {
    ...
    private static List<string> ExtractFlattenedHeaders(List<XElement> elements, bool flattenHierarchy)
    {
    ...
    private static void ExtractHeadersFromElement(XElement element, HashSet<string> headers, string prefix,
    ...
    private static string? ExtractValueFromPath(XElement element, string path)
    {
    ...
    private static string ConvertFromTabularData(XmlData input, object? options)
    {
    ...
    private static List<string> ExtractHeaders(List<XElement> recordElements, bool flattenHierarchy)
    {
    ...
    private static void ExtractHeadersRecursive(XElement element, HashSet<string> headers, string prefix)
    {
        foreach (var child in element.Elements())
        {
    ...
    private static string? ExtractValue(XElement record, string path, bool flattenHierarchy)
    {
        if (path.StartsWith('@'))
        {
    ...
    private static string QuoteValue(string value, char delimiter)
    {
