...
*/
    ...
    private static void ProcessRowsInGroup(XElement groupElement, CsvData input, List<string[]> rows,
        XmlOutputFormat outputFormat, bool useCData, string rowElementName, bool includeRowNumbers,
    ...
    private static void ProcessHierarchicalData(XElement rootElement, CsvData input, bool useCData,
    ...
    private static void ProcessRegularData(XElement rootElement, CsvData input, XmlOutputFormat outputFormat,
    ...
    private static List<string[]> GetSortedRows(CsvData input, bool sortRows, string? sortByColumn, bool ascending)
    {
