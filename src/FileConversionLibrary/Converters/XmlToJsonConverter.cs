...
public class XmlToJsonConverter : IConverter<XmlData, string>
{
    ...
    private static void PreserveCDataSections(XElement? element)
    {
    ...
    private static void RemoveWhitespaceTextNodes(JToken token)
    {
    ...
    private static void ConvertStringValues(JToken token)
    {
        if (token is JObject obj)
        {
